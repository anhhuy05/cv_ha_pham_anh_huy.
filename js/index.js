...
class EditManager {
    ...
    saveData() {
        ...
        document.querySelectorAll('[data-field]').forEach(el => {
            data[el.dataset.field] = el.tagName === 'INPUT' || el.tagName === 'TEXTAREA' ? el.value.trim() : el.textContent.trim();
        });
...
class AnimationManager {
    ...
    observeElements() {
        ...
        document.querySelectorAll('.about-card, .career-card, .skills-card, .project-card, .contact-info, .contact-form, .social-links, .certificates-section').forEach(el => {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.about-card, .skills-card, .project-card, .contact-form').forEach(card => {
